...
function DTIphone () {
        ...
        const getTodos = async () => {
            try {
                const res = await axios.get(
                    'http://localhost:2453/api/product/productPagination_category/4?page=1'
                )
                // console.log(res.data)
                setTodosState(res.data.tutorials)
            } catch (error) {
    ...
    // const [todostate, getTodostate] = useState([]);
    // useEffect(() => {
    //     const getTodos = async () => {
    //         try {
    //             const res = axios.get ('http://localhost:2453/api/product/all?_limit=10')
    //             console.log(res.data)
    //         } catch (error) {
    //             console.log(error.message)
    //         }
    ...
    // useEffect(()=>{
    //     fetch('http://localhost:2453/api/product/all')
    //     .then(res => res.json)
    //     .then(posts => {
    //         setPosts(posts); 
    //         // setData = (data)
